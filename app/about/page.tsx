      ...
      <main className="flex-1 py-20">
        <div className="mx-auto px-4 sm:px-6" style={{ maxWidth: "50rem" }}>
          ...
          <div className="prose prose-slate max-w-none text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
            <p className="mb-4">
              Добро пожаловать в <strong>Whale Abyss</strong> — ваш надежный сервис для профессионального буста в Genshin Impact. Мы понимаем, что в современном мире не всегда хватает времени на полное исследование необъятных миров Тейвата, сбор всех сундуков и выполнение рутинных заданий.
            </p>
            <p className="mb-4">
              Именно поэтому мы собрали команду опытных игроков, которые готовы взять эту задачу на себя. Наша главная цель — обеспечить быстрый, качественный и абсолютно безопасный рост вашего аккаунта.
            </p>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li><strong>Опытные бустеры:</strong> Наша команда состоит из игроков высоких рангов, знающих все секреты игры.</li>
            </ul>
            <p className="mt-8">
