      ...
      <main className="flex-1 py-20">
        <div className="mx-auto px-4 sm:px-6" style={{ maxWidth: "50rem" }}>
          ...
          <div className="prose prose-slate max-w-none text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
            <p className="mb-4">
              Добро пожаловать в <strong>Whale Abyss</strong> — ваш надежный сервис для профессионального сопровождения аккаунтов в Genshin Impact. Мы понимаем, что в современном мире не всегда хватает времени на полное исследование необъятных миров Тейвата.
            </p>
            <p className="mb-4">
