        ...
        <div className="lg:col-span-5 bg-slate-50/80 rounded-3xl p-6 border border-slate-100 flex flex-col gap-6 shadow-sm">
          ...
          <div className="border-t border-slate-200 pt-4 flex flex-col gap-3">
            ...
            <button
              disabled={isLoading}
              onClick={handlePay}
              className="inline-flex items-center justify-center w-full mt-2 py-4 rounded-full bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
