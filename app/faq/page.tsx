...
const FAQ_ITEMS: { q: string; a: ReactNode }[] = [
  ...
  {
    q: "3. Сколько времени занимает оказание услуги?",
    a: "Срок обработки заявки — до 5 дней, подготовка материалов и консультации — до 7 дней. Время реализации может варьироваться в зависимости от типа услуги и загруженности сервиса. Уточнить точные сроки можно в чате поддержки.",
  },
  {
    q: "4. Кто оказывает услуги?",
    a: "Услуги оказываются лично самозанятой Гуровой Майей Павловной (ИНН 230412509070) в рамках режима НПД. Это гарантирует персональный контроль качества и единую точку ответственности. Чеки на полученные оплаты формируются через сервис ФНС «Мой налог».",
  },
  {
