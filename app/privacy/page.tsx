          ...
          <div className="space-y-8 text-sm sm:text-base leading-relaxed text-black">
            ...
            <section>
              ...
              <div className="space-y-2">
                ...
                <p>4.3. Оператор не запрашивает у Пользователя логины, пароли или иные средства доступа к его игровым или иным учётным записям. Такие данные не требуются для оказания информационно-консультационных услуг и не подлежат обработке Оператором.</p>
              </div>
            </section>
