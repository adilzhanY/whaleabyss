...
export const LEGAL = {
  ...
  // Адрес.
  // Точный адрес ИП публикуется в ЕГРИП и доступен по ИНН на egrul.nalog.ru,
  // поэтому здесь указан общий регион. При желании можно заменить на полный
  // адрес регистрации или адрес арендованного «виртуального офиса».
