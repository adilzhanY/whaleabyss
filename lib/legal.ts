...
export const LEGAL = {
  ...
  /**
   * "self_employed"           — НПД (текущая форма)
   * "individual_entrepreneur" — ИП (не используется)
   *
   ...
   */
  CURRENT_LEGAL_FORM: "self_employed" as
    | "self_employed"
  ...
  // ОГРНИП — не используется для самозанятых.
  OGRNIP: "" as string,
  OGRNIP_DATE: "" as string,
